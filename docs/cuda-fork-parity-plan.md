...
| **nnbench eval B16(固定批,W=32)** | **871 nnEval/s**(批周期 18.37ms) | M0 直测(2026-08-17) |
...
| M1 | C1 cuBLASLt top-N 计时重排 + C0 经典 cublas nvjet 试探 | nnbench eval B16 +3% 起步;对拍 PASS;ABBA 留痕;入 plan JSON | M0 |
...
| 方案 C tcgen05 | 🔶 C0/C1 待动工(最高优先级) | H3 证伪 cuBLASLt 走 tcgen05;探针 tests/probe_cublaslt_algos.rs 已入库 |
